...
public class EmailableReport implements IReporter {
  ...
  private String fileName = "emailable-report2.html";
  ...
  protected void writeStylesheet() {
    ...
    writer.print(".passedodd td {background-color: #cee8ce}");
    writer.print(".passedeven td {background-color: #cee8ce}");
    writer.print(".skippedodd td {background-color: #DDD}");
    writer.print(".skippedeven td {background-color: #CCC}");
    writer.print(".failedodd td,.attn {background-color: #ffadad}");
    writer.print(".failedeven td,.stripe .attn {background-color: #ffadad}");
  ...
  protected void writeSuiteSummary() {
    ...
    for (SuiteResult suiteResult : suiteResults) {
      ...
      for (TestResult testResult : suiteResult.getTestResults()) {
        ...
        totalTestsCount = passedTests + failedTests + skippedTests;
       
        totalPassPercentage =(double) passedTests / totalTestsCount;
        
        totalPassPercentage = totalPassPercentage * 100;
        ...
        writeTableData(decimalFormat.format(totalPassPercentage), "num");
    ...
    if (testIndex > 1) {
      ...
      writeTableHeader(decimalFormat.format(totalPassPercentage), "num");
      ...
      for (ClassResult classResult : classResults) {
        ...
        for (MethodResult methodResult : classResult.getMethodResults()) {
          ...
          buffer
              ...
              .append(resultsCount)
              .append("\">")
              .append(formatter.format(startTime.getTime()))
              .append("</td>")
              .append("<td rowspan=\"")
              .append(resultsCount)
              .append("\">")
              .append(convertTimeToString(duration))
              .append("</td></tr>");
          scenarioIndex++;
